    ...
    <>
      ...
      <nav className={`${styles.SideBar} ${isActive ? styles.isActive : ""}`}>
        ...
        <div className={styles.SettingButtonsContainer}>
          <button className={styles.SettingButtons}>
            <img src={profile} alt="profile" />
            <br />
            <p className={styles.SettingButtonsText}>Profile</p>
          </button>
          <button className={styles.SettingButtons}>
            <img src={settings} alt="settings" />
            <br />
            <p className={styles.SettingButtonsText}>Settings</p>
          </button>
          <button className={styles.SettingButtons}>
            <img src={logout} alt="logout" />
            <br />
            <p className={styles.SettingButtonsText}>Log out</p>
          </button>
        </div>
      </nav>
    </>
