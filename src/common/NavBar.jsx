    ...
    <>
      <div className = {styles.persistent_nav_bar}>
        ...
        <div className = {styles.user_interface_plus_languageBar}>
          <div className={styles.language_flag_ribbon}>Language: 
            ...
            <div>
              <div className={styles.register_and_login}>
                <Link to = '/home'><img style={{height:'24px'}} src={avatar_white_icon} alt='avatar_white_icon'/></Link>
                <Link to ='/signup' style={{textDecoration:'none', color: '#ffffff'}}>Register</Link> |
                <Link to ='/signin' style={{textDecoration:'none', color: '#ffffff'}}>Login</Link>
              </div>
            </div>
        </div>
      </div>
