...
export default function StageFour() {
  ...
  const [displayedContent, setDisplayedContent] = useState({
    ...
    component: components["learningPathways"],
  });
        ...
        <div className={styles.topLevel_nav_bar}>
          <button
            ...
            className={`${styles.buttons} ${
              displayedContent.name === "learningPathways" ? styles.toggle : ""
            }`}
          >
            Learning Pathways
          </button>
          <button
            ...
            onClick={handleContentClick}
            className={`${styles.buttons} ${
              displayedContent.name === "digitalTechnologies"
                ? styles.toggle
                : ""
            }`}
          >
          ...
          <button
            ...
            onClick={handleContentClick}
            className={`${styles.buttons} ${
              displayedContent.name === "keyCompetencies" ? styles.toggle : ""
            }`}
          >
            Key Competencies
          </button>
          <button
            ...
            onClick={handleContentClick}
            className={`${styles.buttons} ${
              displayedContent.name === "iR4_0" ? styles.toggle : ""
            }`}
          >
            IR 4.0
          </button>
          ...
          <div className={styles.hidden_content_container}>
            <div className={styles.hiddenRadio}>
              ...
              <input
                ...
                id="learningPathways"
                name="content"
                value="learningPathways"
                onChange={handleContentClick}
                checked={displayedContent.name === "learningPathways"}
              />
              ...
              <input
                ...
                onChange={handleContentClick}
                checked={displayedContent.name === "digitalTechnologies"}
              />
              ...
              <input
                ...
                id="keyCompetencies"
                name="content"
                value="keyCompetencies"
                onChange={handleContentClick}
                checked={displayedContent.name === "keyCompetencies"}
              />
              ...
              <input
                ...
                value="iR4_0"
                onChange={handleContentClick}
                checked={displayedContent.name === "iR4_0"}
              />
            </div>
          </div>
        </div>
