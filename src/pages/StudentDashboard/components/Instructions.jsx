  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.main}>
        ...
        <div className={styles.p1}>Go to https://scratch.mit.edu. Click on <span className={styles.pinkcolortext}>Join Scratch.</span></div>
        <div className={styles.image}><img src={Projectinstructions}alt=""/></div>
